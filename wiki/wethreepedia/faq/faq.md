...
- [FARMER FAQ](#farmer-faq)
  ...
  - [Farming and Maintenance](#farming-and-maintenance)
    ...
    - [**Can I change my farm's name on polkadot.js?**](#can-i-change-my-farms-name-on-polkadotjs)
...
***
### **Can I change my farm's name on polkadot.js?**

It's possible to delete and rename farms through the Polkadot UI. Head to the extrinsics section, select the account that owns the farm, choose tfgridModule from the first drop down, then deleteFarm or updateFarm. For mainnet, use [this link](https://polkadot.js.org/apps/?rpc=wss%3A%2F%2Ftfchain.dev.grid.tf%2Fws#/extrinsics). 
...
NB2: This is a collective effort. A big ***Thank You*** to the great Threefold Community. Many Q+A are contributions from the great farmers in the [Telegram Farmer Group](https://t.me/threefoldfarmers) and also from the amazing [Threefold Forum](https://forum.threefold.io/).
